...
export const metadata: Metadata = {
  title: "공무원·군인 퇴직수당 계산기 (재직기간별 지급율)",
  description:
    "기준소득월액과 재직연수를 입력하면 공무원연금법·군인연금법 시행령 기준 퇴직수당을 계산합니다. 재직기간별 지급율(6.5~39%)을 반영합니다.",
  openGraph: {
    title: "공무원·군인 퇴직수당 계산기 (재직기간별 지급율)",
    description:
      "기준소득월액과 재직연수를 입력하면 공무원연금법·군인연금법 시행령 기준 퇴직수당을 계산합니다. 재직기간별 지급율(6.5~39%)을 반영합니다.",
    ...
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        <p className="text-sm text-[#5B6478]">
          기준소득월액과 재직연수를 입력하면 공무원연금법·군인연금법 시행령 기준 퇴직수당을
          계산합니다. 재직기간별 지급율(6.5~39%)을 반영합니다.
        </p>
      </header>
